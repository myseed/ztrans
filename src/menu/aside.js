...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/order-management?status=1', title: '未接单订单', icon: 'file-text' },
      { path: '/order-management?status=2', title: '未完成订单', icon: 'file-text' },
      { path: '/order-management?status=3', title: '已完成订单', icon: 'file-text' },
      { path: '/order-management?status=4', title: '异常订单', icon: 'file-text' },
    ]
  },
  {
    title: '客户管理',
