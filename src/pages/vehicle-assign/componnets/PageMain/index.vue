<template>
    <div>
        <el-table
            ...
            <el-table-column label="用车时间" :show-overflow-tooltip="true" width="200">
                <template slot-scope="scope">
            ...
            <el-table-column label="合作伙伴" :show-overflow-tooltip="true" width="200">
                <template slot-scope="scope">
            ...
            <el-table-column label="下单时间" :show-overflow-tooltip="true" width="200">
                <template slot-scope="scope">
            ...
            <el-table-column label="操作" align="center" width="300" fixed="right">
                <template slot-scope="scope">
                    <el-button
                            size="mini"
                            type="primary"
                            @click="selectCar(scope.$index, scope.row)">指派车辆
                    </el-button>
                    <el-button
                            size="mini"
                    ...
                    <el-button
                            size="mini"
                            type="danger"
                            @click="handleDelete(scope.$index, scope.row)">删除订单
                    </el-button>
                </template>
            </el-table-column>
