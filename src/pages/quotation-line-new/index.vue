<template>
  <d2-container>
    ...
    <el-dialog title="新增普通报价" :visible.sync="addDialog">
      <div class="block" style="text-align: left">
        线路设置
      </div>
      <div class="block" style="text-align: left; padding: 0 15px">
        <el-form :model="addItem" label-width="120px" size="mini" >
    ...
    <el-dialog title="编辑普通报价" :visible.sync="editDialog">
      <div class="block" style="text-align: left">
        线路设置
      </div>
      <div class="block" style="text-align: left; padding: 0 15px">
    ...
    handleSubmit(form) {
      ...
      getCustomerPrice(param){
          this.$router.push({
              ...
              query: {routerDetailSeries: param.routerDetailSeries},
          });
      },
