<template>
  <d2-container>
    ...
    <page-main
      ...
      @stopCustomerPrice="stopCustomerPrice"
      :loading="loading"/>
    <page-footer
      slot="footer"
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      ...
      _stopRouterByRouterId(params) {
          stopRouterByRouterId(params)
              .then(res => {
                  if (res.code === 0) {
                      this.$message({
                          type: "success",
