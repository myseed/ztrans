            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-button @click="onCheckOrderDetail(scope.$index, scope.row)" type="text" size="small">
                            查看已接单明细
                        </el-button>
                    </template>
                </el-table-column>
            ...
            getOrderDetail(param) {
                this.$router.push({
                    ...
                    query: {
                        ...
                        commondOrderStatus: param.commondOrderStatus,
                        allmonthOrderTaskSeries: param.allmonthOrderTaskSeries
                    },
                });
            },
