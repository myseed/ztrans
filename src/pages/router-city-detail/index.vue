...
export default {
  ...
  methods: {
      ...
      onAddPriceConfirm() {
          ...
          this._addRouterPriceNew(this.addRouterPriceModel);
          this.addRouterPriceModel.routerPriceList=[];
      },
      _addRouterPriceNew(params) {
          addRouterPriceNew(params)
              .then(res => {
                  if (res.code === 0) {
      ...
      updateRouterPrice() {
          ...
          this._updateRouterPriceNew(this.priceSetAddItem0);
      },
      _updateRouterPriceNew(params) {
          updateRouterPriceNew(params)
              .then(res => {
                  if (res.code === 0) {
