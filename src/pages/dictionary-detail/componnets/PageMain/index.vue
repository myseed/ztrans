<template>
  <div>
    <el-table
      ...
      <el-table-column label="业务明细" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{scope.row.bizContentName}}
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      this.$emit("editDictionary",{bizTypeId:row.bizTypeId,bizTypeName:row.bizTypeName,bizContentName:row.bizContentName,bizContentId:row.bizContentId});
    },
    handleDelete(index, row) {
