      ...
      <el-table-column label="操作" align="center" fixed="right">
        <template slot-scope="scope">
          ...
          <el-button
                  size="mini"
                  type="primary"
                  @click="editDictionary(scope.$index, scope.row)">更换</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
  ...
  methods: {
    ...
    handleSelectionChange(val) {
      ...
      editDictionary(index, row) {
          this.$emit("editDictionary",{bizTypeId:row.bizTypeId,bizContentId:row.bizContentId,bizTypeName:row.bizTypeName,});
      },
      check(index, row) {
