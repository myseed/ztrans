  ...
  <d2-container type="full" class="page">
    <template>
      <el-form :model="searchItem" size="mini" label-width="140px">
        ...
        <el-form-item label="系统参考价" >
          <el-input v-model="driverPrice"  style="width: 500px;" disabled></el-input>
        </el-form-item>
        <el-form-item label="手动设置参考价" >
          <el-input v-model="driverRealPrice" placeholder="手动设置参考价" style="width: 500px;"></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-button type="primary" @click="_createOrderByWeb" :loading="searching">创建竞标任务</el-button>
  ...
  methods: {
    ...
    _createOrderByWeb() {
      this.searching = true;
        ...
        if (this.createOrder.breakMoney === '') {
            this.$message({
                type: 'error',
                message: '违约金不可以为空！',
            });
